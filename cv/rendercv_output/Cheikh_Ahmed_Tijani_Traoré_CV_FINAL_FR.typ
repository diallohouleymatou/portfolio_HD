...
Directeur des Systèmes d'Information avec 4 ans d'expérience en digitalisation métier, Odoo, Microsoft 365, donnée et reporting.
...
#regular-entry(
  [
    ...
    - Pilote la structuration de la fonction SI et un programme de transformation digitale couvrant gouvernance, documentation, sécurité et adoption.

    - Contribue à la digitalisation de CPI CHUES, programme immobilier pour enseignants du Sénégal, avec un travail sur clarté des parcours et lisibilité de l'offre.

    - Définit le socle Microsoft 365 + Odoo pour centraliser processus métier, collaboration, gestion documentaire et reporting.

    - Cadre une feuille de route de 6 mois centrée sur traçabilité, contrôles d'accès, sauvegarde et conduite du changement.
...
#regular-entry(
  [
    ...
    - Intervient en parallèle sur cadrage produit, analyse métier, documentation et articulation technico-commerciale.
...
#regular-entry(
  [
    ...
    - A piloté des missions de digitalisation et d'évolution de systèmes métiers, en combinant cadrage, reporting, coordination et exécution technique.

    - A mené pour EBS des développements critiques sur logistique, achats, ventes, comptabilité, CRM, site web et SAV mobile dans un contexte de 6 dépôts et 30 routes.

    - A conduit des migrations Odoo v18 et formé environ 100 utilisateurs sur logistique, achats, stock et qualité de donnée.
...
Google\/Coursera - Google AI Professional Certificate

Linux Foundation (LFD114) - Porting Software to RISC-V

== Compétences

#strong[Transformation & SI:] gouvernance SI, digitalisation, documentation, reporting, conduite du changement

#strong[Développement:] Spring Boot, Angular, API design, multi-tenant, Docker

#strong[Data & IA appliquée:] SQL, Pandas, scikit-learn, KPI, reporting

#strong[Plateformes:] Odoo 18, Microsoft 365, PostgreSQL, Azure, Linux, CI\/CD
