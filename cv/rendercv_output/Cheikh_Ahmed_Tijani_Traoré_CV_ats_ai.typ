...
Information Systems Director and software leader with 4+ years delivering business-critical systems, now focused on information-system structuring, digital transformation, ERP enablement, applied AI workflows, and executive reporting.

== Core Expertise

#strong[IS Transformation:] IS governance, digitalization programs, document control, reporting, change enablement

#strong[Business Systems & ERP:] Odoo transformations, logistics and finance workflows, migration planning, user enablement

#strong[Data & Applied AI:] SQL, Pandas, scikit-learn, KPI pipelines, reporting automation, lightweight AI workflows
...
#regular-entry(
  [
    ...
    - Leads the structuring of the IS function and a digital transformation program.

    - Defines the Microsoft 365 + Odoo operating backbone for business workflows, document management, collaboration, and executive reporting.

    - Owns a 6-month roadmap covering governance, security, backup, process traceability, and user adoption.
...
#regular-entry(
  [
    ...
    - Continues part-time consulting on product scoping, business analysis, documentation, and technical-commercial alignment.
...
#regular-entry(
  [
    ...
    - Led digitalization and system-evolution engagements combining business scoping, technical implementation, and operational coordination for multiple clients.
    ...
    - Led Odoo migration programs to v18 and trained around 100 users to improve data quality and process discipline.
...
#regular-entry(
  [
    ...
    - Built a Student Management Service using Spring Boot, Angular, Docker, and DigitalOcean on a multi-tenant architecture.
...
#strong[DataCamp • AI Engineer for Developers Associate]: applied ML engineering workflows, model integration, and practical AI implementation patterns.

#strong[Google\/Coursera • Google AI Professional Certificate]: structured grounding in applied AI concepts and product-oriented use cases.

#strong[Linux Foundation (LFD114) • Porting Software to RISC-V]: software portability and systems-level engineering fundamentals.
