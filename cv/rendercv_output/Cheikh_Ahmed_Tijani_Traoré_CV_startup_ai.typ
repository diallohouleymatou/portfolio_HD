...
Information Systems Director and software builder focused on pragmatic digital transformation, operating systems, data workflows, and applied AI integration in real-world business environments.
...
#regular-entry(
  [
    ...
    - Leads IS structuring and a transformation program across governance, documentation, security, and adoption.

    - Defines the Microsoft 365 + Odoo stack for business workflows, document control, collaboration, and executive reporting.

    - Executes a 6-month roadmap centered on traceability, controls, backup, and change management.
...
#regular-entry(
  [
    ...
    - Built and evolved client business systems across logistics, procurement, sales, accounting, and CRM domains in live operational environments.

    - Delivered EBS workflow and reporting capabilities across 6 warehouses and 30 routes and led Odoo v18 upgrade streams with user training.
...
#regular-entry(
  [
    ...
    - Built a Student Management Service with Spring Boot and Angular on a multi-tenant model, deployed with Docker on DigitalOcean.
...
Delivered architecture decisions balancing business constraints, maintainability, and deployment speed across transformation contexts.

== Technical Stack

#strong[IS & Platform:] Microsoft 365, Odoo 18, PostgreSQL, Docker, Linux, DigitalOcean, CI\/CD
...
#strong[DataCamp • AI Engineer for Developers Associate]: practical model and workflow integration for application contexts.

#strong[Google\/Coursera • Google AI Professional Certificate]: broad applied AI concepts for product-level implementation.

#strong[Linux Foundation (LFD114) • Porting Software to RISC-V]: systems-level rigor relevant to software portability and architecture thinking.
